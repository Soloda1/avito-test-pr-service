...
type PRInputPort interface {
	CreatePR(ctx context.Context, prID string, authorID uuid.UUID, title string) (*models.PullRequest, error)
	ReassignReviewer(ctx context.Context, prID string, oldReviewerID uuid.UUID) (*models.PullRequest, error)
